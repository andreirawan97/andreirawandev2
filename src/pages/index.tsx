      ...
      <StickyContainer className="flex flex-col">
        <Sticky>
          {({ style }) => (
            <div
              id="aboutMe"
              className={styles.stickyHeaderGlass}
          ...
          <div className="flex flex-1 lg:flex-row flex-col items-center mb-12">
            <div className="flex-1">
              ...
              <div className="flex flex-row items-center mb-6">
                ...
                <Image className="w-9 h-9" src={LogoTraveloka} alt="" />
              </div>
          ...
          <div className="flex lg:flex-row flex-col">
            <div className="flex-1 justify-center lg:pr-3 pb-6">
              <div className="flex flex-col rounded-xl bg-white shadow">
                <Image className="rounded-xl mb-3" src={ImageCSIC} alt="" />
            ...
            <div className="flex-1 justify-center lg:px-3 pb-6">
              <div className="flex flex-col rounded-xl bg-white shadow">
                <Image className="rounded-xl mb-3" src={ImageIFRA} alt="" />
                <div className="flex flex-col px-3 pb-3">
                  <span className="mb-3">
            ...
            <div className="flex-1 justify-center lg:pl-3 pb-6">
              <div className="flex flex-col rounded-xl bg-white shadow">
                <Image className="rounded-xl mb-3" src={ImageConmedia} alt="" />
                <div className="flex flex-col px-3 pb-3">
                  <span className="mb-3">
